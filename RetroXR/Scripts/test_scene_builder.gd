...
const GENERATIONS: Array = [
	{
		...
		"systems": [
			["atari2600", BOX, "Atari 2600"],
			["atari5200", BOX, "Atari 5200"],
		],
	},
	{
		...
		"systems": [
			...
			["mastersystem", BOX, "Sega Master System"],
			["atari7800", BOX, "Atari 7800"],
		],
	},
	{
		"title": "4TH GENERATION", "years": "1987 – 1993",
		"systems": [
			["snes", BOX, "Super Nintendo"],
			["genesis", BOX, "Sega Genesis"],
			["neogeo", BOX, "Neo Geo AES"],
			["tg16", BOX, "PC Engine / TurboGrafx-16"],
			["gb", "game_boy_primitive", "Game Boy"],
			["atarilynx", "atari_lynx", "Atari Lynx"],
	...
	},
	{
		...
		"systems": [
			["psx", BOX, "PlayStation"],
			["n64", BOX, "Nintendo 64"],
			["saturn", BOX, "Sega Saturn"],
			["3do", BOX, "Panasonic 3DO"],
			["atarijaguar", BOX, "Atari Jaguar"],
			["virtualboy", "virtual_boy_primitive", "Virtual Boy"],
			["ngp", "neo_geo_pocket", "Neo Geo Pocket"],
	...
	},
	{
		...
		"systems": [
			...
			["psp", "psp_primitive", "PlayStation Portable"],
		],
	},
	{
		"title": "8TH GENERATION", "years": "2011 – 2017",
		"systems": [
			["n3ds", "n3ds_primitive", "Nintendo 3DS"],
		],
	},
]
