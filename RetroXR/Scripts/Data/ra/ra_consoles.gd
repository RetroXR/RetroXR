...
const CONSOLE_MAP := {
	...
	"snes": 3,               # RC_CONSOLE_SUPER_NINTENDO
	"n64": 2,             # RC_CONSOLE_NINTENDO_64
	...
	"pokemini": 24,           # RC_CONSOLE_POKEMON_MINI

	# Sega
	"mastersystem": 11,          # RC_CONSOLE_MASTER_SYSTEM
	"genesis": 1,              # RC_CONSOLE_MEGA_DRIVE
	"segacd": 9,                 # RC_CONSOLE_SEGA_CD
	"sega32x": 10,               # RC_CONSOLE_SEGA_32X
	"saturn": 39,            # RC_CONSOLE_SATURN
	"dreamcast": 40,              # RC_CONSOLE_DREAMCAST
	"gamegear": 15,              # RC_CONSOLE_GAME_GEAR
	"sg-1000": 33,                 # RC_CONSOLE_SG1000
	"sega_pico": 68,              # RC_CONSOLE_PICO

	# Sony
	"psx": 12,            # RC_CONSOLE_PLAYSTATION
	"ps2": 21,           # RC_CONSOLE_PLAYSTATION_2
	"psp": 41,   # RC_CONSOLE_PSP

	# NEC
	"tg16": 8,               # RC_CONSOLE_PC_ENGINE
	"tg-cd": 76,           # RC_CONSOLE_PC_ENGINE_CD
	# RetroAchievements files SuperGrafx titles under the PC Engine console.
	"supergrafx": 8,              # RC_CONSOLE_PC_ENGINE
	"pcfx": 49,                  # RC_CONSOLE_PCFX
	"pc88": 47,                  # RC_CONSOLE_PC8800
	"pc98": 48,                  # RC_CONSOLE_PC9800

	# Atari
	"atari2600": 25,             # RC_CONSOLE_ATARI_2600
	"atari5200": 50,             # RC_CONSOLE_ATARI_5200
	"atari7800": 51,             # RC_CONSOLE_ATARI_7800
	"atarilynx": 13,             # RC_CONSOLE_ATARI_LYNX
	"atarijaguar": 17,           # RC_CONSOLE_ATARI_JAGUAR
	"atarijaguarcd": 77,              # RC_CONSOLE_ATARI_JAGUAR_CD
	"atarist": 36,               # RC_CONSOLE_ATARI_ST
	...
	"channelf": 57,              # RC_CONSOLE_FAIRCHILD_CHANNEL_F
	...
	"fbneo": 27,               # RC_CONSOLE_ARCADE
	"neogeo": 27,                 # RC_CONSOLE_ARCADE — MVS/AES sets live here

	# Home computers
	"c64": 30,          # RC_CONSOLE_COMMODORE_64
	"vic20": 34,        # RC_CONSOLE_VIC20
	"amiga": 35,        # RC_CONSOLE_AMIGA
	"apple2": 38,               # RC_CONSOLE_APPLE_II
	"amstradcpc": 37,                    # RC_CONSOLE_AMSTRAD_PC
	"msx": 29,                    # RC_CONSOLE_MSX
	"zx81": 31,                   # RC_CONSOLE_ZX81
	"zxspectrum": 59,            # RC_CONSOLE_ZX_SPECTRUM
	"x1": 64,               # RC_CONSOLE_SHARPX1
	"x68000": 52,           # RC_CONSOLE_X68K
...
##   amigacd32, cdtv  — RA tracks Amiga only as floppy-based Amiga
