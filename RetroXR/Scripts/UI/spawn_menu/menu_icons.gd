...
const RESCRAPE  := 0xF05C2   # md-database_refresh — scraped already, scrape again
const SCRAPE_ALL := 0xF163B  # md-database_arrow_down — every unscraped game on the page
...
const MOVE_UP   := 0xF0737   # md-arrow_up_bold   — earlier in a priority list
const MOVE_DOWN := 0xF072E   # md-arrow_down_bold — later in it
const CHECKBOX_ON  := 0xF0132  # md-checkbox_marked — in a multi-select list
const CHECKBOX_OFF := 0xF0131  # md-checkbox_blank_outline — left out of it
const CLOSE     := 0xF0156   # md-close           — dismiss a panel
const PLUS      := 0xF0415   # md-plus            — make a new one
const SAVE_OVER := 0xF0C7    # fa-save            — write over the save that is there
