...
func set_crt_enabled(on: bool) -> void:
	crt_enabled = on
	_update_crt_button_color()
	NetworkManager.report_event(NetEvents.Event.EV_TV_CRT, {"tv": self, "on": on})
...
func set_stereo_mode(mode: int) -> void:
	...
	NetworkManager.report_event(NetEvents.Event.EV_TV_STEREO,
...
func set_widescreen(on: bool) -> void:
	...
	NetworkManager.report_event(NetEvents.Event.EV_TV_ASPECT,
...
func _report_channel_state() -> void:
	NetworkManager.report_event(NetEvents.Event.EV_TV_CHANNEL, {
		"tv": self,
